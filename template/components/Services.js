  ...
  const services = [
    {
      ...
      image: '/images/template-service-1.avif',
      icon: '🏠'
    },
    {
      title: 'Template Service 2',
      description: 'Template service description 2.',
      image: '/images/template-service-2.avif',
      icon: '🏢'
    },
    {
      title: 'Template Service 3',
      description: 'Template service description 3.',
      image: '/images/template-service-3.avif',
      icon: '✨'
    },
    {
      title: 'Template Service 4',
      description: 'Template service description 4.',
      image: '/images/template-service-4.avif',
      icon: '📦'
    },
    {
      title: 'Template Service 5',
      description: 'Template service description 5.',
      image: '/images/template-service-5.avif',
      icon: '🛢️'
    },
    {
      title: 'Template Service 6',
      description: 'Template service description 6.',
      image: '/images/template-service-6.avif',
      icon: '🐜'
    },
    {
      title: 'Template Service 7',
      description: 'Template service description 7.',
      image: '/images/template-service-7.avif',
      icon: '🛋️'
    },
    {
      title: 'Template Service 8',
      description: 'Template service description 8.',
      image: '/images/template-service-8.avif',
      icon: '❄️'
    },
    {
      title: 'Template Service 9',
      description: 'Template service description 9.',
      image: '/images/template-service-9.avif',
      icon: '🪞'
    },
  ];
